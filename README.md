...
│   ├── Clean dataset.csv                        # generated by Sect_2_and_3_EDA_Feature_Selection.ipynb
│   ├── Model dataset.csv                        # generated by Sect_4_Predictive Models.ipynb
│   └── clean_data_with_predictions.csv          # generated by Sect_4_Predictive Models.ipynb
│
└── Notebooks/
...
**`Clean dataset.csv`**  
Deduplicated and de-identified base dataset produced from the raw file after removing `Make` and `Model` and dropping duplicate rows (generated by Sect_2_and_3_EDA_Feature_Selection.ipynb).

**`Model dataset.csv`**  
Feature-engineered modelling dataset created from `Clean dataset.csv` for downstream training and analysis (generated by Sect_4_Predictive Models.ipynb).

**`clean_data_with_predictions.csv`**  
An enriched output dataset containing the cleaned data plus prediction results from the predictive modelling stage (generated by Sect_4_Predictive Models.ipynb).
...
This follows the project pipeline from raw data through cleaning, feature engineering, modelling, and final classification analysis.
